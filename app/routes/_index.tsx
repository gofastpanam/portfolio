  ...
  return (
    <div className="min-h-screen bg-transparent relative z-10">
      ...
      <div className="relative min-h-[45vh] flex flex-col items-center justify-center overflow-hidden mt-8 px-4 md:px-6">
        ...
        <p className="text-lg md:text-xl text-white mt-2 mb-8 text-center max-w-2xl px-4">
      ...
      <div className="max-w-4xl mx-auto px-4 mb-16">
        <h2 className="text-3xl font-bold text-white mb-8 text-center">Compétences</h2>
        
        <div className="grid md:grid-cols-2 gap-8">
          {/* Main Skills */}
          <div className="bg-white/70 backdrop-blur-md rounded-lg shadow-lg p-6 md:p-8 transition-all duration-300 hover:bg-white/90">
      ...
      <div className="max-w-6xl mx-auto px-4 mb-16">
        <h2 className="text-3xl font-bold text-white mb-8 text-center">Projets Récents</h2>
